                            ...
                            <div class="max-w-full flex lg:max-w-lg justify-center self-center items-end">
                                ...
                                <div class="relative mr-4">
                                    ...
                                    <div class="lg:flex gap-2">
                                        ...
                                        <button name="search" value="search" type="submit" class="w-full lg:w-1/4 inline-flex text-white bg-indigo-500 border-0 py-2.5 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Search</button>

                                        <!-- 
                                            Search top headlines
                                         -->

                                        <button name="search" value="latest" type="submit" class="mt-1 w-full lg:w-1/4 inline-flex text-white bg-red-500 border-0 py-2.5 px-6 focus:outline-none hover:bg-red-600 rounded text-lg">Latest</button>
